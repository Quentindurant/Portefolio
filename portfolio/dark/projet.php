...
<section class="main-content text-center revealator-slideup revealator-once revealator-delay1">
    ...
    <!-- SECTION ENTREPRISE -->
    <section class="title-section text-left text-sm-center revealator-slideup revealator-once revealator-delay1">
        <h1>Projet <span>ENTREPRISE</span></h1>
                        ...
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <div class="row open-sans-font">
                                    ...
                                    <div class="col-6 mb-2">
                                        <i class="fa fa-external-link pr-2"></i><span class="project-label">Preview </span>: <span class="ft-wt-600 uppercase"><a href="https://quentindurant.github.io/site-Apple/" target="_blank">LDAP</a></span>
                                    </div>
                                </div>
                            </figcaption>
                            <!-- Project Details Ends -->
